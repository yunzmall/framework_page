        ...
        <div class="grid-content">
          <div class="right-system">
            ...
            <div class="systen-new">
              ...
              <div class="active-weith-color" style="height:80px">
          ...
          <div  class="right-system">
            ...
            <div class="update-log" v-show="log.length > 0" :style="{height: search.upgrade_status === 0 ? '483px' :  '633px'}">
    ...
    methods:{
        ...
        agreeCheck(val){
          ...
          this.agreeLoading = true;
            ...
            //   return
            // }
            $http.post('/admin/system/update/system-info').then(({data,msg,result}) => {
                if(result){
        ...
        getDataLog(page){
            ...
            $http.post('/admin/system/update/log',{page}).then(({data,msg,result}) => {
                if(result){
                    this.log = data.data;
        ...
        checkUpdateFile(){
          ...
          this.init_loading = true;
          $http
            .get("/admin/system/update/verifyCheck", {})
            .then(response => {
        ...
        upgrade() {
          ...
          console.log(that.not_files,'that.not_files');
          $http
            .post("/admin/system/update/fileDownload", {
              protocol:{
                file:1,
                update:1
              },
